<?php
/**
 * Navbar compartilhada da área do transportador.
 *
 * Uso:
 *   <?php $active_nav = 'painel'; require __DIR__ . '/includes/navbar.php'; ?>
 *
 * Requer o CSS:  <link rel="stylesheet" href="../css/transportador/navbar.css">
 *
 * Variáveis opcionais (definir ANTES do require):
 *   $active_nav    string  chave do item ativo (ex.: painel|entregas|perfil|chats|favoritos)
