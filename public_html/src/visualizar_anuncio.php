...
<head>
    ...
    <link rel="stylesheet" href="css/visualizar_anuncio.css">
                    ...
                    <div class="produto-info">
                        ...
                        if ($is_logged_in) {
                            try {
                                ...
                                if ($mostrar_avaliar) {
                                    echo '<div class="avaliar-produto-wrapper"><a href="avaliar?tipo=produto&produto_id='.urlencode($anuncio_id).'" class="btn btn-info">Avaliar este produto</a></div>';
                                }
                            } catch (Exception $e) {
                ...
                <?php if (!empty($avaliacoes)): ?>
                    ...
                    <?php if ($total_avaliacoes > 3): ?>
                        <div class="ver-mais-avaliacoes">
                            ...
                            <?php else: ?>
                                <a href="login?redirect=avaliacoes.php?tipo=produto&id=<?php echo $anuncio_id; ?>" class="btn-ver-mais btn-ver-mais-login">
