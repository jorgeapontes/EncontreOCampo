...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .filter-btn { padding: 8px 15px; border: 1px solid #ddd; background: white; border-radius: 5px; cursor: pointer; font-size: 13px; transition: all 0.3s; }
        ...
        .produto-nome { font-size: 13px; color: #666; margin-bottom: 5px; display: flex; align-items: center; gap: 5px; }
        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item"><a href="chats.php" class="nav-link active">Chats</a></li>
                    ...
                    ?>
                        <div class="conversa-card <?php echo $tem_nao_lidas ? 'nao-lida' : ''; ?> <?php echo $esta_arquivado ? 'arquivado' : ''; ?>" 
                                ...
                                <div class="conversa-info">
                                    ...
                                    <?php if ($conversa['ultima_mensagem']): ?>
                                        <div class="ultima-mensagem">
                                            ...
                                            <?php 
                                            if (strpos($conversa['ultima_mensagem'], '[Imagem]') !== false) { echo '<i class="fas fa-image"></i> [Imagem]'; } 
                            ...
                            <div class="conversa-actions">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo $chat_url; ?>" class="btn-chat"><i class="fas fa-comments"></i> Abrir Chat</a>
