<?php
// src/vendedor/historico_compras.php
...
// Preparar lista de propostas aceitas (compras feitas por este usuário)
...
try {
    $sql_propostas = "SELECT p.*, pr.nome as produto_nome, pr.imagem_url as produto_imagem, u.nome as vendedor_nome
                      ...
                      WHERE p.comprador_id = :comprador_id AND p.status = 'aceita' " . $filtro_periodo . ' ' . $filtro_status . "
                      ORDER BY " . $order_sql;
    ...
    error_log('Erro ao buscar propostas comprador (vendor view): ' . $e->getMessage());
}
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Histórico de Compras - Vendedor</title>
