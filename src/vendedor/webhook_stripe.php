...
// $endpoint_secret = '***REMOVED_WEBHOOK_SECRET***';
...
if (!$endpoint_secret) {
    ...
    if ($is_production) {
        $endpoint_secret = '***REMOVED_WEBHOOK_SECRET***'; // Substitua pela sua chave de produção
    } else {
        $endpoint_secret = '***REMOVED_WEBHOOK_SECRET***'; // Sua chave de teste
    }
}
